...
import { ActionWithOptionalArgs } from "@qcut-app/constants/actions";
import { isAppleDevice, isDOMElement, isTypableElement } from "@qcut-app/lib/utils";
import { KeybindingConfig, ShortcutKey } from "@qcut-app/types/keybinding";
import {
	handleError,
	ErrorCategory,
	ErrorSeverity,
