...
import LandingIntroGate from "@/components/creator-os/LandingIntroGate";
...
export default function Page() {
  return (
    <LandingIntroGate manifestUrl={process.env.NEXT_PUBLIC_SPLAT_INTRO_MANIFEST_URL || undefined}>
      <SplinePartnerHero />
      <CreatorOSLanding />
    </LandingIntroGate>
  );
