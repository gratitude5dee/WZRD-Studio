...
export const CANONICAL_FAL_MODELS: CanonicalFalModel[] = [
  ...
  // QCut editor text-to-image endpoints (advanced)
  canonicalModel({
    id: 'fal-ai/bytedance/seedream/v3/text-to-image',
    name: 'Seedream 3 Text to Image',
  ...
  canonicalModel({
    ...
    description: 'Bytedance Seedream v4 text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'image_size', 'num_images', 'max_images', 'seed'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/bytedance/seedream/v4.5/text-to-image',
    name: 'Seedream 4.5 Text to Image',
    description: 'Bytedance Seedream v4.5 text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'image_size', 'num_images', 'max_images', 'sync_mode', 'enable_safety_checker', 'seed'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/flux-2-flex',
    name: 'FLUX 2 Flex',
    description: 'FLUX 2 Flex text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'image_size', 'num_images', 'guidance_scale', 'num_inference_steps', 'seed'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/imagen4/preview/ultra',
    name: 'Imagen 4 Ultra',
    description: 'Google Imagen 4 Ultra text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'aspect_ratio', 'num_images', 'seed'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
  ...
  canonicalModel({
    ...
    name: 'GPT Image 2',
    description: 'OpenAI GPT Image 2 text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'image_size', 'num_images', 'quality', 'output_format'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/gpt-image-1.5',
    name: 'GPT Image 1.5',
    description: 'OpenAI GPT Image 1.5 text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'image_size', 'num_images', 'quality', 'background', 'output_format', 'sync_mode'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    ...
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'image_size', 'num_images', 'negative_prompt', 'seed'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/wan/v2.7/pro/text-to-image',
    name: 'Wan 2.7 Pro Text to Image',
    description: 'Wan 2.7 Pro text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    name: 'Wan 2.7 Edit',
    description: 'Wan 2.7 image editing.',
    category: 'image-editing',
    media_type: 'image',
    workflow_type: 'image-edit',
    ui_group: 'advanced',
    supports: ['prompt', 'image_urls', 'image_size', 'num_images', 'negative_prompt', 'enable_prompt_expansion', 'seed'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/wan/v2.7/pro/edit',
    name: 'Wan 2.7 Pro Edit',
    description: 'Wan 2.7 Pro image editing.',
    category: 'image-editing',
    media_type: 'image',
    workflow_type: 'image-edit',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    name: 'Z-Image Turbo',
    description: 'Fast Z-Image text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'aspect_ratio', 'num_images', 'resolution', 'output_format'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/wan/v2.2-a14b/text-to-image',
    name: 'Wan 2.2 A14B Text to Image',
    description: 'Wan 2.2 A14B text-to-image generation.',
    category: 'image-generation',
    media_type: 'image',
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    name: 'Seedream 4.5 Edit (Bytedance)',
    description: 'Bytedance Seedream v4.5 multi-image editing.',
    category: 'image-editing',
    media_type: 'image',
    workflow_type: 'image-edit',
    ui_group: 'advanced',
    supports: ['prompt', 'image_urls', 'image_size', 'num_images', 'max_images', 'sync_mode', 'enable_safety_checker', 'seed'],
    defaults: { num_images: 1 },
  }),
  canonicalModel({
    id: 'fal-ai/phota',
    ...
    workflow_type: 'text-to-image',
    ui_group: 'advanced',
    supports: ['prompt', 'aspect_ratio', 'num_images', 'quality', 'image_size', 'output_format'],
    defaults: { num_images: 1 },
  }),
  ...
  // QCut editor text-to-video picker endpoints
  canonicalModel({
    id: 'fal-ai/kling-video/v3/pro/text-to-video',
    name: 'Kling 3.0 Pro Text to Video',
    description: 'Kling 3.0 Pro text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'aspect_ratio', 'negative_prompt', 'cfg_scale'],
    defaults: {},
  }),
  canonicalModel({
    id: 'fal-ai/kling-video/v3/standard/text-to-video',
    name: 'Kling 3.0 Standard Text to Video',
    description: 'Kling 3.0 Standard text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    description: 'Kling 2.6 Pro text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    description: 'Kling 2.5 Turbo Pro text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    id: 'fal-ai/kling-video/v2.5-turbo/standard/text-to-video',
    name: 'Kling 2.5 Turbo Standard Text to Video',
    description: 'Kling 2.5 Turbo Standard text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    name: 'LTX Video 2.0 Pro Text to Video',
    description: 'LTX Video 2.0 Pro text-to-video with audio.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'resolution', 'fps', 'generate_audio', 'aspect_ratio'],
    defaults: {},
  }),
  canonicalModel({
    id: 'fal-ai/ltxv-2/text-to-video/fast',
    name: 'LTX Video 2.0 Fast Text to Video',
    description: 'LTX Video 2.0 Fast text-to-video with audio.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    name: 'LTX 2.3 Pro Text to Video',
    description: 'LTX 2.3 Pro text-to-video with audio.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    description: 'LTX 2.3 Fast text-to-video with audio.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    id: 'fal-ai/veo3.1',
    name: 'Veo 3.1',
    description: 'Google Veo 3.1 text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'aspect_ratio', 'resolution', 'generate_audio', 'enhance_prompt', 'auto_fix'],
    defaults: {},
  }),
  canonicalModel({
    id: 'fal-ai/veo3.1/fast',
    name: 'Veo 3.1 Fast',
    description: 'Google Veo 3.1 Fast text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    name: 'Veo 3.1 Lite',
    description: 'Google Veo 3.1 Lite text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'aspect_ratio', 'resolution', 'generate_audio', 'auto_fix'],
    defaults: {},
  }),
  canonicalModel({
    id: 'fal-ai/minimax/hailuo-2.3/standard/text-to-video',
    name: 'Hailuo 2.3 Standard Text to Video',
    description: 'MiniMax Hailuo 2.3 Standard text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'prompt_optimizer'],
    defaults: {},
  }),
  canonicalModel({
    id: 'fal-ai/minimax/hailuo-2.3/pro/text-to-video',
    name: 'Hailuo 2.3 Pro Text to Video',
    description: 'MiniMax Hailuo 2.3 Pro text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
  ...
  canonicalModel({
    ...
    description: 'Vidu Q3 text-to-video generation with audio.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'resolution', 'aspect_ratio', 'audio'],
    defaults: {},
  }),
  canonicalModel({
    id: 'fal-ai/bytedance/seedance-2.0/text-to-video',
    name: 'Seedance 2.0 Text to Video',
    description: 'Bytedance Seedance 2.0 text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'resolution', 'aspect_ratio', 'seed'],
    defaults: {},
  }),
  canonicalModel({
    id: 'alibaba/happy-horse/text-to-video',
    name: 'Happy Horse 1.0 Text to Video',
    description: 'Alibaba Happy Horse 1.0 text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'resolution', 'ratio', 'negative_prompt', 'audio_url', 'prompt_extend', 'watermark', 'seed'],
    defaults: {},
  }),
  canonicalModel({
    id: 'wan/v2.6/text-to-video',
    name: 'WAN 2.6 Text to Video',
    description: 'WAN 2.6 text-to-video generation.',
    category: 'video-generation',
    media_type: 'video',
    workflow_type: 'text-to-video',
    ui_group: 'advanced',
    supports: ['prompt', 'duration', 'resolution', 'aspect_ratio', 'negative_prompt', 'enable_prompt_expansion', 'multi_shots'],
    defaults: {},
  }),
